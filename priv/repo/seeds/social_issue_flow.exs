flows = [
  ...
  %{social_issue_id: 1, next_social_issue_id: 3, is_yes: false, deleted_at: nil},
  %{social_issue_id: 1, next_social_issue_id: 5, is_yes: false, deleted_at: nil},
  %{social_issue_id: 3, next_social_issue_id: 11, is_yes: false, deleted_at: nil},
  %{social_issue_id: 11, next_social_issue_id: 8, is_yes: false, deleted_at: nil},
  %{social_issue_id: 11, next_social_issue_id: 6, is_yes: true, deleted_at: nil},
  %{social_issue_id: 5, next_social_issue_id: 21, is_yes: false, deleted_at: nil},
  %{social_issue_id: 6, next_social_issue_id: 8, is_yes: false, deleted_at: nil},
]
